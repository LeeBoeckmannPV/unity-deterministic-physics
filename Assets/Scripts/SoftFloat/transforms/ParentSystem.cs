...
namespace UnityS.Transforms
{
    public abstract partial class ParentSystem : SystemBase
    {
        ...
        struct FindMissingChild : IJob
        {
            ...
            public void Execute()
            {
                ...
                for (int i = 0; i < parents.Length; i++)
                {
                    ...
                    if (!ChildFromEntity.HasBuffer(parent))
                    {
        ...
        void UpdateChangeParents()
        {
            ...
            var gatherChangedParentsJobHandle = gatherChangedParentsJob.ScheduleParallel(m_ExistingParentsGroup, Dependency);
        ...
        void UpdateDeletedParents()
        {
            ...
            EntityManager.RemoveComponent(childEntities.AsArray(), typeof(Parent));
            EntityManager.RemoveComponent(childEntities.AsArray(), typeof(PreviousParent));
            EntityManager.RemoveComponent(childEntities.AsArray(), typeof(LocalToParent));
